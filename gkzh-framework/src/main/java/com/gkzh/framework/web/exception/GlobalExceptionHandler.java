package com.gkzh.framework.web.exception;
...
import com.gkzh.common.exception.DemoModeException;
import com.gkzh.common.exception.ServiceException;
import com.gkzh.common.utils.StringUtils;
import com.gkzh.common.utils.html.EscapeUtil;
...
public class GlobalExceptionHandler
{
    ...
    @ExceptionHandler(StuAuthException.class)
    public AjaxResult handleStudentAuthException(StuAuthException e) {
        log.error(e.getMessage(), e);
        Integer code = e.getCode();
        return StringUtils.isNotNull(code) ? AjaxResult.error(code, e.getMessage()) : AjaxResult.error(e.getMessage());
    }
