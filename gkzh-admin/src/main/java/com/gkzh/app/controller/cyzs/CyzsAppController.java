package com.gkzh.app.controller.cyzs;
...
import com.gkzh.cyzs.vo.AnswerResult;
import com.gkzh.cyzs.vo.QuestionVO;
import com.gkzh.cyzs.vo.SubmitAnswerRequest;
...
@Api("危机应对")
@RestController
@RequestMapping("/api/cyzs")
public class CyzsAppController extends FrontBaseController {
    @Autowired
    private ICyzsQuestionService questionService;
    ...
    public AjaxResult getRandomQuestions() {
        try {
            List<QuestionVO> questions = questionService.getRandomQuestions(5);
