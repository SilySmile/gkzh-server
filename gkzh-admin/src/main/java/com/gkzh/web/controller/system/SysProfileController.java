package com.gkzh.web.controller.system;
...
import com.gkzh.common.utils.file.FileUploadUtils;
import com.gkzh.common.utils.file.FileUtils;
import com.gkzh.common.utils.file.MimeTypeUtils;
import com.gkzh.framework.web.service.TokenService;
...
public class SysProfileController extends BaseController
{
    ...
    public AjaxResult avatar(@RequestParam("avatarfile") MultipartFile file) throws Exception
    {
        ...
        {
            LoginUser loginUser = getLoginUser();
            String avatar = FileUploadUtils.upload(GkzhConfig.getAvatarPath(), file, MimeTypeUtils.IMAGE_EXTENSION, true);
            if (userService.updateUserAvatar(loginUser.getUserId(), avatar))
            {
                String oldAvatar = loginUser.getUser().getAvatar();
                if (StringUtils.isNotEmpty(oldAvatar))
                {
                    FileUtils.deleteFile(GkzhConfig.getProfile() + FileUtils.stripPrefix(oldAvatar));
                }
