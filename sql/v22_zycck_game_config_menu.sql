...
(2400,'职业猜猜看',2235,30,'zycck','','','','1',0,'C','0','0','zycck:config:list','job','admin',NOW(),'admin',NOW(),'zycck游戏配置目录'),
...
UPDATE sys_menu SET parent_id=2235, menu_name='职业猜猜看', path='zycck', component='', menu_type='C', perms='zycck:config:list', update_time=NOW() WHERE menu_id=2400;
