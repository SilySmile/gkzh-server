package com.gkzh.lottery.controller;
...
import com.gkzh.lottery.service.IGkzhMbtiProductService;
...
public class GkzhMbtiProductController extends BaseController
{
     ...
     * 查询职愿探究-MBTI商品列表
     */
    @PreAuthorize("@ss.hasPermi('lottery:product:list')")
    @GetMapping("/list")
     ...
     * 导出职愿探究-MBTI商品列表
     */
    @PreAuthorize("@ss.hasPermi('lottery:product:export')")
     ...
     * 获取职愿探究-MBTI商品详细信息
     */
    @PreAuthorize("@ss.hasPermi('lottery:product:query')")
     ...
     * 新增职愿探究-MBTI商品
     */
    @PreAuthorize("@ss.hasPermi('lottery:product:add')")
     ...
     * 修改职愿探究-MBTI商品
     */
    @PreAuthorize("@ss.hasPermi('lottery:product:edit')")
     ...
     * 删除职愿探究-MBTI商品
     */
    @PreAuthorize("@ss.hasPermi('lottery:product:remove')")
