...
import com.gkzh.lottery.service.IGkzhMbtiStudentChoiceService;
...
public class GkzhMbtiStudentChoiceController extends BaseController
{
     ...
     * 查询职愿探究-学生选择记录列表
     */
    @PreAuthorize("@ss.hasPermi('lottery:choice:list')")
    @GetMapping("/list")
     ...
     * 导出职愿探究-学生选择记录列表
     */
    @PreAuthorize("@ss.hasPermi('lottery:choice:export')")
     ...
     * 获取职愿探究-学生选择记录详细信息
     */
    @PreAuthorize("@ss.hasPermi('lottery:choice:query')")
     ...
     * 新增职愿探究-学生选择记录
     */
    @PreAuthorize("@ss.hasPermi('lottery:choice:add')")
