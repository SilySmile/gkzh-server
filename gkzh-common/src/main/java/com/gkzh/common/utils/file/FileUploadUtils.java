package com.gkzh.common.utils.file;
...
import com.gkzh.common.exception.file.FileNameLengthLimitExceededException;
import com.gkzh.common.exception.file.FileSizeLimitExceededException;
import com.gkzh.common.exception.file.InvalidExtensionException;
import com.gkzh.common.utils.DateUtils;
import com.gkzh.common.utils.StringUtils;
import com.gkzh.common.utils.uuid.IdUtils;
import com.gkzh.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = GkzhConfig.getProfile();
    ...
    {
        int dirLastIndex = GkzhConfig.getProfile().length() + 1;
